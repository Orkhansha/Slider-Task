#pragma checksum "C:\Users\HP\Desktop\Programmer\Asp.net\FrontBack\FrontToBack\Front-to-back\Front-to-back\Views\Pricing\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6292cf9e55ec78aed2fd842f31bdf75bcf28e5a5"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6292cf9e55ec78aed2fd842f31bdf75bcf28e5a5", @"/Views/Pricing/Index.cshtml")]
    ...
    public class Views_Pricing_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "C:\Users\HP\Desktop\Programmer\Asp.net\FrontBack\FrontToBack\Front-to-back\Front-to-back\Views\Pricing\Index.cshtml"
...
<section class=""bg-light pt-sm-0 py-5"">
    <div class=""container py-5"">
        ...
        <div class=""pricing-horizontal row col-10 m-auto d-flex shadow-sm rounded overflow-hidden bg-white"">
            ...
            <div class=""pricing-horizontal-body offset-lg-1 col-md-5 col-lg-4 d-flex align-items-center pl-5 pt-lg-0 pt-4"">
                <ul class=""text-left px-4 list-unstyled mb-0 light-300"">
                    <li><i class=""bx bxs-circle me-2""></i>5 Users<");
            WriteLiteral(@"/li>
        ...
        <div class=""pricing-horizontal row col-10 m-auto d-flex shadow-sm rounded overflow-hidden my-5 bg-white"">
            ...
            <div class");
            WriteLiteral(@"=""pricing-horizontal-body offset-lg-1 col-md-5 col-lg-4 d-flex align-items-center pl-5 pt-lg-0 pt-4"">
                <ul class=""text-left px-4 list-unstyled mb-0 light-300"">
        ...
        <!-- Start Pricing Horizontal -->
        <div class=""pricing-horizontal row col-10 m-auto d-flex shadow-sm rounded overflow-hidden bg-white"">
            <div class=""pricing-ho");
            WriteLiteral(@"rizontal-icon col-md-3 text-center bg-secondary text-light py-4"">
                <i class=""display-1 bx bx-package pt-4""></i>
            ...
            WriteLiteral(@"px-4 btn-outline-primary mb-3"">Get Now</a>
                </div>
            </div>
        </div>
        <!-- End Pricing Horizontal -->
...
<section class=""container py-5"">
    ...
    <div class=""row d-flex align-items-center pb-5"">
        ...
        <div class=""col-lg-6"">
            ...
            WriteLiteral(@"-icon col-3 text-center m-auto text-secondary ml-5 py-2"">
            ...
            <div class=""pricing-list shadow-sm py-sm-0 py-5"">
                <div class=""row p-2"">
                    <div class=""pricing-list-icon col-3 te");
            WriteLiteral(@"xt-center m-auto text-secondary ml-5 py-2"">
                        <i class=""display-3 bx bx-package""></i>
                    </div>
                    <div class=""pricing-list-body col-md-5 align-items-center pl-3 pt-2"">
                        <ul class=""list-unstyled text-center light-300"">
            ...
            <div class=""pricing-list shadow-sm rounded-botton rounded-3 py-sm-0 py-5"">
                <div class=""row p-2"">
                    <div cla");
            WriteLiteral(@"ss=""pricing-list-icon col-sm-3 text-center m-auto text-secondary ml-5 py-2"">
                        <i class=""display-3 bx bx-package""></i>
                    </div>
                    <div class=""pricing-list-body col-md-5 align-items-center pl-3 pt-2"">
                        <ul class=""list-unstyled text-center light-300"">
